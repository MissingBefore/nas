...
public class OrderBillingDO {
	...
	public OrderBillingDO(String u_id, String car_id, String order_num, String order_price, String order_paymethod,
			String order_state, String order_createdate, String remarks) {
		super();
		this.u_id = u_id;
		this.car_id = car_id;
